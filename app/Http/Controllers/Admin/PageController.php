...
class PageController extends Controller {
    ...
    public function store(Request $request) {
        ...
        return redirect()
            ...
            ->with('success', 'Нова стораінка успішно створена');
    }
    ...
    public function update(Request $request, Page $page) {
        ...
        return redirect()
            ->route('admin.page.show', ['page' => $page->id])
            ->with('success', 'Сторінка успішно відредагована');
    }
    ...
    public function removeImage(Request $request) {
        ...
        if (Storage::disk('public')->exists($path)) {
            ...
            return 'Зображення було видалено';
        }
        return 'Не вдалось видалити зображеня';
    }
    ...
    public function destroy(Page $page) {
        if ($page->children->count()) {
            return back()->withErrors('Неможливо видалити сторінку у якої є дочірні сторіни');
        }
        $this->removeImages($page->content);
        $page->delete();
        return redirect()
            ->route('admin.page.index')
            ->with('success', 'Сторінка була успішно видалена');
    }
}
